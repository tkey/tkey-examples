  ...
  return (
    <div className="container">
      ...
      <footer className="footer">
        <a href="https://github.com/Web3Auth/web3auth-core-kit-examples/tree/main/mpc-core-kit/tkey-mpc-react-firebase-example" target="_blank" rel="noopener noreferrer">
          Source code
        </a>
      </footer>
    </div>
